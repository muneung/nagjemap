...
function loadSwarmWidget() {
    ...
    const swarmData = {
        "2번도로": ["<strong>도토링</strong>이 나무에 가득!", "<strong>파오리</strong>가 파를 등에 지고 왔다!"],
        "3번도로": ["<strong>두루지벌레</strong>가 무언가에 몰두 중...", "<strong>콩알뚜기</strong>가 머리에 뛰어들지 않게 주의!"],
        "4번도로": ["<strong>야돈</strong>이 꼬리로 낚시 중!", "<strong>들눈해</strong>의 군집을 발견 가능!"],
        "5번도로": ["<strong>노고치</strong>를 찾을 수 있는 천재일우의 기회?!", "<strong>페라페</strong>의 합동 연주가 한창!"],
        "6번도로": ["<strong>내던숭이</strong>로 인한 낙석에 주의!", "<strong>절벼게</strong> 무리의 탈각 시즌!"],
        "7번도로": ["<strong>깜지곰</strong>이 꿀을 모으는 중!", "<strong>단굴</strong>의 겨울나기 행진!"],
        "8번도로": ["<strong>포니타</strong>가 질주 중!", "<strong>줄뮤마</strong>가 질주 중!"],
        "9번도로": ["<strong>노라키</strong>의 울음소리 목격담!", "<strong>소미안</strong>이 떠다니는 중!"],
        "10번도로": ["<strong>베루키</strong>가 훈련중!", "<strong>그푸리</strong>가 굴러다니는 중!"],
        "11번도로": ["<strong>물거미</strong>의 사냥 시기...!", "<strong>단단지</strong>가 나무열매 숙성 중!"],
        "12번도로": ["<strong>요가랑</strong>이 명상 중!", "<strong>판짱</strong>이 길을 막는 중!?"],
        "13번도로": ["<strong>콘치</strong> 군집이 호수에 출몰!", "<strong>코코리</strong>가 굴러다니는 중!"],
        "14번도로": ["<strong>꼬이밍고</strong> 군집 휴식 중!", "<strong>식스테일</strong>이 일광욕 중!"],
        "15번도로": ["<strong>몸지브림</strong> 발견 소식!", "<strong>쫀도기</strong>가 일광욕 중!"],
        "16번도로": ["<strong>터검니</strong>의 흔적 발견!", "<strong>빙큐보</strong> 무리가 허들링 중!"],
        "20번도로": ["<strong>플로젤</strong>의 파도타기!", "<strong>돌살이</strong>가 새 집을 찾는 중!"],
        "21번도로": ["<strong>꼬시레</strong>의 굴 발견!", "<strong>찌르성게</strong>에게 감전되지 않도록 주의!"]
    };
